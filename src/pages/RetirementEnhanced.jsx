      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <div className="flex items-center justify-between mb-4">
          ...
          <Button
            ...
            className={`gap-1.5 text-xs h-8 px-3 transition-all ${saveStatus === 'saved' ? 'bg-gain/20 text-gain border-gain/30 hover:bg-gain/20' : ''}`}
            variant={saveStatus === 'saved' ? 'outline' : Object.keys(pendingUpdates).length > 0 ? 'default' : 'outline'}
          >
